...
fn submatrix() {
    ...
    let a2 = Matrix::matrix4(-6.0, 1.0, 1.0, 6.0,
                             -8.0, 5.0, 8.0, 6.0,
                             -1.0, 0.0, 8.0, 2.0,
                             -7.0, 1.0, -1.0, 1.0);
    let r2 = a2.submatrix(2, 1);
    assert_eq!(r2, Matrix::matrix3(-6.0, 1.0, 6.0, -8.0, 8.0, 6.0, -7.0, -1.0, 1.0));
}
...
fn determinant() {
    ...
    let a2 = Matrix::matrix4(-2.0, -8.0, 3.0, 5.0,
                             -3.0, 1.0, 7.0, 3.0,
                             1.0, 2.0, -9.0, 6.0,
                             -6.0, 7.0, 7.0, -9.0);
...
#[test]
fn inverse() {
    let a1 = Matrix::matrix4(-4.0, 2.0, -2.0, -3.0,
                             9.0, 6.0, 2.0, 6.0,
                             0.0, -5.0, 1.0, -5.0,
                             0.0, 0.0, 0.0, 0.0);
    let r1 = a1.inverse();
    ...
    let a2 = Matrix::matrix4(-5.0, 2.0, 6.0, -8.0,
                            1.0, -5.0, 1.0, 8.0,
                            7.0, 7.0, -6.0, -7.0,
                            1.0, -3.0, 7.0, 4.0);
    let r2 = a2.inverse().expect("Unable to find inverse of a2");
    let e2 = Matrix::matrix4(0.21805,0.45113,0.24060,-0.04511,
                             -0.80827,-1.45677,-0.44361,0.52068,
                             -0.07895,-0.22368,-0.05263,0.19737,
                             -0.52256,-0.81391,-0.30075,0.30639);
    r2.assert_approx_eq(&e2);

    let a3 = Matrix::matrix4(8.0, -5.0, 9.0, 2.0,
                             7.0, 5.0, 6.0, 1.0,
                             -6.0, 0.0, 9.0, 6.0,
                             -3.0, 0.0, -9.0, -4.0);
    let r3 = a3.inverse().expect("a3 inverse is undefined");
    let e3 = Matrix::matrix4(-0.15385,-0.15385,-0.28205,-0.53846,
                             -0.07692,0.12308,0.02564,0.03077,
                             0.35897,0.35897,0.43590,0.92308,
                             -0.69231,-0.69231,-0.76923,-1.92308);
    r3.assert_approx_eq(&e3);

    let a4 = Matrix::matrix4(9.0, 3.0, 0.0, 9.0,
                             -5.0, -2.0, -6.0, -3.0,
                             -4.0, 9.0, 6.0, 4.0,
                             -7.0, 6.0, 6.0, 2.0);
    let r4 = a4.inverse().expect("a4 inverse is undefined");
    let e4 = Matrix::matrix4(-0.04074,-0.07778,0.14444,-0.22222,
...
#[test]
fn multiply_inverse() {
    let a = Matrix::matrix4(3.0, -9.0, 7.0, 3.0,
                            3.0, -8.0, 2.0, -9.0,
                            -4.0, 4.0, 4.0, 1.0,
                            -6.0, 5.0, -1.0, 1.0);
    let b = Matrix::matrix4(8.0,2.0,2.0,2.0,
                            3.0,-1.0,7.0,0.0,
                            7.0,0.0,5.0,4.0,
                            6.0,-2.0,0.0,5.0);
    let c = a * b;
